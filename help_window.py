...
def open_help():
    ...
    label_mid = tk.Label(scrollable_frame, text="↓ How to use ↓", justify="left", wraplength=400)
    ...
    label_below = tk.Label(scrollable_frame, text=(
    ...
    label_additional = tk.Label(scrollable_frame, text=(
